...
<span class="c">  : {</span>
<span class="c">     scott:{bonus:{...} list, dept:{deptno:int, dname:string, loc:string} list,</span>
<span class="c">            emp:</span>
<span class="c">                {comm:real, deptno:int, empno:int, ename:string,</span>
<span class="c">                 hiredate:string, job:string, mgrno:int, sal:real} list,</span>
<span class="c">            salgrade:{...} list, ...}, wordle:{...}, ...}</span></code></pre>
</div>
