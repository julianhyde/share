...
Last week I wrote about my [goals for Morel]({% post_url
2020-02-25-morel-a-functional %}), extending a simple functional
language (Standard ML) with relational operations so that it can be
